...
const app = () => {
  ...
  const handleLocation = (loc) => {
    ...
    fetchWeatherForcast({
      ...
      // storeData('city', 'Melbourne');
      // getData('city').then(city => console.log(city)); // 预期输出: 'Melbourne'
                ...
                <View className='flex flex-col items-center gap-16 flex-1'>
                  ...
                  <View className='flex-row mt-4 gap-10 '>
                    ...
                    <View className='flex-row gap-2 items-center justify-center'>
                      ...
                      <Text className='text-white'>{'' + weather?.forecast?.forecastday[0].astro?.sunrise}</Text>
                    </View>
                  </View>
                </View>
